...
#define START_ADDRESS			(UINT64)0x00000000
#define END_ADDRESS				(UINT64)0x110000000
#define OFFSET_PROC_TAG			4
#define OFFSET_IMAGEFILENAME	0x450+0x80	// 0x450 from beginning of EPROCESS to IMAGEFILENAME, 0x60-4 from "Proc" tagged pool to beginning of EPROCESS
#define SIZE_IMAGEFILENAME		15
#define OFFSET_PRIORITYCLASS	0x45f+0x80	// PRIORITYCLASS is usually equal 0x2
#define VALUE_PRIORITYCLASS		0x2				// expected value
#define SIZE_PRIORITYCLASS		1
#define OFFSET_PROCESSLOCK		0x2d8+0x80
#define SIZE_PROCESSLOCK		0x8
#define VALUE_PROCESSLOCK		0x0				// expected _EX_PUSH_LOCK == 0
#define OFFSET_UNIQUEPROCESSID	0x2e0+0x80			
#define SIZE_UNIQUEPROCESSID	0x8
#define OFFSET_TOKEN			0x358+0x80			
#define SIZE_TOKEN				0x8
#define OFFSET_FORKINPROGRESS	0x380+0x80
